...
class TangentTrainer(BaseTrainer):
    def train(self):
        thaw(self.args, self.model, mode='tangent')
        params = collect_params(self.model, quiet=False)
        ...
        for epoch in range(self.args.epochs):
            ...
            train_epoch(self.args, self.model, self.train_loader, self.criterion, self.regularizer, self.optimizer, wd=self.args.wd, epoch=epoch, mode='regular', enable_bn=self.args.trainer.use_train_mode)
